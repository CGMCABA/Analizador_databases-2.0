...
export function LineaDeTiempo({ solicitudes, meses }: LineaDeTiempoProps) {
  ...
  return (
    ...
    >
      <div className="p-5 pb-0">
        ...
        <p className="text-xs text-slate-400 dark:text-slate-500 ml-6 mb-4">
          Actividad diaria · hover para ver motivo más frecuente del día
        </p>

        {!hasFechas ? (
          <div className="flex items-center justify-center h-32 text-slate-400 text-sm pb-5">
