...
export function DriveFilePicker({ onBuffer, onError, cargando }: DriveFilePickerProps) {
    ...
    return (
      <div className="flex flex-col items-center gap-4 py-2">
        ...
        <button
          ...
          className="flex items-center gap-3 bg-white dark:bg-[#252d3d] border border-slate-300 dark:border-[#2e3852] rounded-xl px-5 py-3 text-slate-700 dark:text-slate-200 font-medium text-sm hover:bg-slate-50 dark:hover:bg-[#2e3852] transition-colors disabled:opacity-60 disabled:cursor-not-allowed shadow-sm"
        >
          {cargandoAuth ? (
  ...
  return (
    <div className="flex flex-col gap-3 w-full">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            ...
            title="Actualizar"
            className="p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-[#252d3d] text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors disabled:opacity-50"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-[#252d3d] text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 transition-colors"
          >
      ...
      {!cargandoArchivos && carpetas.length + archivos.length > 8 && (
        <div className="relative">
          <input
            ...
            className="w-full text-sm bg-slate-50 dark:bg-[#131720] border border-slate-200 dark:border-[#1f2535] rounded-lg px-3 py-2 pl-8 text-slate-700 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-400/50 focus:border-blue-400 dark:focus:border-blue-500 transition-colors"
          />
      ...
      <div className="border border-slate-200 dark:border-[#1f2535] rounded-xl overflow-hidden bg-white dark:bg-[#131720]/50">
        {cargandoArchivos ? (
                  ...
                  {carpetasFiltradas.map((carpeta) => (
                    <li key={carpeta.id}>
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-[#252d3d]/40 transition-colors text-left disabled:opacity-60 disabled:cursor-not-allowed"
                      >
