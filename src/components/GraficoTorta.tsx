...
export function GraficoTorta({ datos, titulo, subtitulo, alturaGrafico = 200 }: GraficoTortaProps) {
  ...
  return (
    <div className={`bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-5 h-full transition-opacity duration-500 ${montado ? "opacity-100" : "opacity-0"}`}>
      <div className="mb-4">
