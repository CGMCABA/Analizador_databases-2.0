...
export function GraficoTiempoRespuesta({ datos, titulo, subtitulo }: GraficoTiempoRespuestaProps) {
  ...
  return (
    <div className={`bg-slate-50 dark:bg-[#0d0f14] rounded-lg border border-amber-200 dark:border-amber-800 p-5 transition-opacity duration-500 ${montado ? "opacity-100" : "opacity-0"}`}>
